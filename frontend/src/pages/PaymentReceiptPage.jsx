...
export default function PaymentReceiptPage() {
  ...
  if (error && !booking) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', color: C.maroon, background: C.cream }}>
      {error}
    </div>
  );
  
  if (!booking) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', color: C.textMuted, background: C.cream }}>
      Booking not found
    </div>
  );
        ...
        {success ? (
          ...
          <>
            ...
            <div style={{ background: C.warmWhite, borderRadius: '0 0 20px 20px', padding: '2rem', border: `1px solid ${C.border}`, borderTop: 'none', boxShadow: '0 4px 20px rgba(128,0,32,0.08)' }}>
              ...
              {/* Price Breakdown */}
              <div style={{ background: C.cream, borderRadius: '16px', padding: '1.5rem', marginBottom: '2rem' }}>
