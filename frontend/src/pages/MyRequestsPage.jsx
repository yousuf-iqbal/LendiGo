...
export default function MyRequestsPage() {
  ...
  if (error) {
    return (
      <div style={{ minHeight: '100vh', padding: '2rem', background: 'transparent' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: '1.5rem' }}>
            {filteredRequests.map((request) => (
              ...
              >
                ...
                {/* Card Footer */}
                <div style={{ padding: '1rem', background: 'transparent', borderTop: `1px solid ${C.border}`, display: 'grid', gridTemplateColumns: 'auto auto auto', gap: '0.5rem' }}>
                  <button
