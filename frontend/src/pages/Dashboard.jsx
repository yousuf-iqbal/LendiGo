  ...
  if (error) return (
    <div style={{ minHeight: "100vh", background: 'transparent', display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ textAlign: "center", zIndex: 1, maxWidth: 400 }}>
        <div style={{ fontSize: "2rem", marginBottom: "1rem", color: C.maroon }}>!</div>
            ...
            {activity.length === 0 ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", maxHeight: 400, overflowY: "auto" }}>
                {activity.slice(0, 8).map((item, i) => (
                  <div key={i} style={{ display: "flex", gap: "0.875rem", padding: "0.875rem", background: 'transparent', borderRadius: 10, borderLeft: `3px solid ${ACTIVITY_COLORS[item.ActivityType] || C.saffron}` }}>
          ...
          <div style={{ background: C.warmWhite, border: `1px solid ${C.border}`, borderRadius: 16, padding: "1.75rem", animation: "fadeUp 0.5s ease 0.48s both" }}>
            ...
            {earnings.length === 0 ? (
              ...
              <>
                  ...
                  {earnings.map((month, i) => {
                    ...
                    return (
                      <div key={i} style={{ display: "flex", gap: "0.875rem", alignItems: "center" }}>
                        ...
                        <div style={{ flex: 1, height: 22, background: 'transparent', borderRadius: 6, overflow: "hidden", border: `1px solid ${C.border}` }}>
                ...
                <div style={{ background: 'transparent', borderRadius: 12, padding: "1rem 1.25rem", border: `1px solid ${C.border}` }}>
