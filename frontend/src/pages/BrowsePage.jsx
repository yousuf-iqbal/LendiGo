...
const Icons = {
  ...
  Filter: () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><polygon points="22 3 2 3 10 13 10 21 14 18 14 13 22 3"/></svg>,
  ...
  Calendar: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>,
};
            ...
            {filtered.map((a, idx) => (
              <div key={a.asset_id} className="asset-card"
                ...
                <div style={{ padding:'1.1rem 1.25rem' }}>
                  ...
                  <p style={{ color:C.textMuted, fontSize:'0.85rem', marginBottom:'0.75rem', display:'flex', alignItems:'center', gap:4 }}><Icons.MapPin /> {a.location || a.city || 'Location not set'}</p>
