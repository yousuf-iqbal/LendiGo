...
export default function ReviewsPage() {
  ...
  return (
    <div style={{ background: 'transparent', minHeight: '100vh', fontFamily: "'Outfit', system-ui, sans-serif" }}>
      <style>{`
        ...
        {userData && (
          <div style={{ background: C.warmWhite, border: `1px solid ${C.border}`, borderRadius: 16, padding: '2rem', marginBottom: '2rem', animation: 'fadeUp 0.5s ease both' }}>
            <div style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start', flexWrap: 'wrap' }}>
              <div style={{ width: 120, height: 120, borderRadius: 16, overflow: 'hidden', background: 'transparent', border: `2px solid ${C.border}`, flexShrink: 0 }}>
                {userData.ProfilePic ? (
              ...
              {[5, 4, 3, 2, 1].map(rating => {
                ...
                return (
                  <div key={rating} style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div style={{ flex: 1, height: 12, background: 'transparent', borderRadius: 6, overflow: 'hidden', border: `1px solid ${C.border}` }}>
              ...
              {reviews.map((review, index) => (
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                    <div style={{ width: 48, height: 48, borderRadius: 12, overflow: 'hidden', background: 'transparent', border: `1px solid ${C.border}`, flexShrink: 0 }}>
                      {review.ReviewerPic ? (
