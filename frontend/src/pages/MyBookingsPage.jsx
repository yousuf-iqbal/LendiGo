            ...
            {bookings.map((b, idx) => {
              ...
              return (
                <div key={bookingId} className="booking-card"
                  ...
                  <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(160px,1fr))', gap:'0.75rem', background:'transparent', borderRadius:12, padding:'0.875rem 1rem', marginBottom:'1rem' }}>
                    <div>
