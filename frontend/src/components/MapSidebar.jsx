...
export default function MapSidebar() {
  const { isMapOpen, toggleMap, closeMap, requests, newRequestPulse, recentActivity } = useMap();
          ...
          <div style={{ flex: 1, overflow: 'auto', padding: '1rem' }}>
            {activeTab === 'map' ? (
              <Suspense fallback={
                ...
                <p style={{ fontSize: '0.7rem', color: C.textFaint, textAlign: 'center', marginTop: '0.75rem' }}>
